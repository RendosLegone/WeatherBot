...
from bot.filters import ContentTypeFilter, PreCheckoutQueryFilter, HasTimeFilter
...
def reg_user_handlers(router: Router):
    ...
    router.message.register(subscribeStep3, StateFilter(ClientStates.setTimer), HasTimeFilter())
